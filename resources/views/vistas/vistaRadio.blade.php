                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="row" style="padding: 5px;">
                        <div class="col-xs-12 col-sm-12 col-md-12 player" style="border: 1px solid #000000;-moz-border-radius: 7px;-webkit-border-radius: 7px;padding: 10px;">
                            <video id="videoRadio" src="http://servicios.noticiasperu.pe/medios/radio/2017/10/02/201710027176139.mp3" controls autobuffer="true" autoplay preload="true" width="100%" poster="http://servicios.noticiasperu.pe/gui/public/img/otros/imgRadio/Noticias_logo.png">
                            </video>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <span id="fechaPauta">{{ $pautasRadio[0]->fechaPauta }}</span>
                            <!--{/!!Form::label('fechaPauta','Fecha: '.$pautasTv[0]->fechaPauta,['class'=>'','id'=>'fechaPauta'])!!}-->
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <label for="medio">Medio: </label>
                            <span id="medio">{{ $pautasRadio[0]->nombreMedio }}</span>
                            <!--{/!!Form::label('medio','Medio: '.$pautasTv[0]->nombreMedio,['class'=>'','id'=>'medio'])!!}-->
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <label for="programa">Programa: </label>
                            <span id="programa">{{ $pautasRadio[0]->nombrePrograma }}</span>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <span id="titular">{{ $pautasRadio[0]->titular }}</span>
                            <!--{/!!Form::label('titular','Titular: '.$pautasTv[0]->titular,['class'=>'','id'=>'titular'])!!}-->
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <label for="texto">Texto: </label>
                            <br>
                            <span id="texto">{{ $pautasRadio[0]->texto }}</span>
